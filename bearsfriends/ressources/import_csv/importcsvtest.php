...
require 'C:/wamp64/www/presta/robot/conn.php';// je fait ma connection avec chemin absolu
require '../bdd/lecture_bdd/rb_prixperso.php';// j'appelle ma lecture de bdd prixperso
